  ...
  <div class="row">
    <div class="col-xs-6">
      ...
      <section class="clearfix">
        <h2 class="separator">Primary Colors</h2>

        <div class="row">
          <div class="col-xs-2">
            <div class="az-color-block background-dark"></div>
            #3c3a3f
          </div>
          <div class="col-xs-2">
            <div class="az-color-block background-blue"></div>
            #1e8cf6
          </div>
          <div class="col-xs-2">
            <div class="az-color-block background-green"></div>
            #27ad8d
          </div>
          <div class="col-xs-2">
            <div class="az-color-block background-whitesmoke"></div>
            #f0f1f5
          </div>
          <div class="col-xs-2">
            <div class="az-color-block background-red"></div>
            #ad1a26
          </div>  
          <div class="col-xs-2">
            <div class="az-color-block background-lightgrey"></div>
            #878888
          </div>
        </div>
      </section>
    ...
    <div class="col-xs-6">
      ...
      <section>
        <h2 class="separator">Fonts</h2>
        <p class="exemple-font-myriad">
          Myriad Pro <br/>
          Le chat qui buvait du whisky
        </p>
        <p class="exemple-font-myriad" style="font-weight:bold;">
          Myriad Pro Bold <br/>
          Le chat qui buvait du whisky
        </p>
        <p class="exemple-font-helvetica">
          Helvetica Neue <br/>
          Le chat qui buvait du whisky
        </p>
      </section>
